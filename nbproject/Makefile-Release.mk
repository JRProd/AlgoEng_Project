...
${OBJECTDIR}/coloring/ConferenceScheduler.o: coloring/ConferenceScheduler.cpp
	${MKDIR} -p ${OBJECTDIR}/coloring
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/ConferenceScheduler.o coloring/ConferenceScheduler.cpp
...
${OBJECTDIR}/conflicts/ConflictGraph.o: conflicts/ConflictGraph.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conflicts/ConflictGraph.o conflicts/ConflictGraph.cpp

${OBJECTDIR}/conflicts/ConflictHandler.o: conflicts/ConflictHandler.cpp
	${MKDIR} -p ${OBJECTDIR}/conflicts
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conflicts/ConflictHandler.o conflicts/ConflictHandler.cpp

${OBJECTDIR}/conflicts/ConflictList.o: conflicts/ConflictList.cpp
	${MKDIR} -p ${OBJECTDIR}/conflicts
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conflicts/ConflictList.o conflicts/ConflictList.cpp

${OBJECTDIR}/distributions/BinomialDistribution.o: distributions/BinomialDistribution.cpp
	${MKDIR} -p ${OBJECTDIR}/distributions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/BinomialDistribution.o distributions/BinomialDistribution.cpp

${OBJECTDIR}/distributions/Distribution.o: distributions/Distribution.cpp
	${MKDIR} -p ${OBJECTDIR}/distributions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/Distribution.o distributions/Distribution.cpp

${OBJECTDIR}/distributions/SkewedDistribution.o: distributions/SkewedDistribution.cpp
	${MKDIR} -p ${OBJECTDIR}/distributions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/SkewedDistribution.o distributions/SkewedDistribution.cpp

${OBJECTDIR}/distributions/TwoTieredDistribution.o: distributions/TwoTieredDistribution.cpp
	${MKDIR} -p ${OBJECTDIR}/distributions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/TwoTieredDistribution.o distributions/TwoTieredDistribution.cpp

${OBJECTDIR}/distributions/UniformDistribution.o: distributions/UniformDistribution.cpp
	${MKDIR} -p ${OBJECTDIR}/distributions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/UniformDistribution.o distributions/UniformDistribution.cpp
...
${OBJECTDIR}/utils/FileHandler.o: utils/FileHandler.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/FileHandler.o utils/FileHandler.cpp

${OBJECTDIR}/utils/MathUtils.o: utils/MathUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/MathUtils.o utils/MathUtils.cpp

${OBJECTDIR}/utils/RandomNumberGenerator.o: utils/RandomNumberGenerator.cpp
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/RandomNumberGenerator.o utils/RandomNumberGenerator.cpp
...
${TESTDIR}/tests/units/ConflictGraphTestRunner.o: tests/units/ConflictGraphTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ConflictGraphTestRunner.o tests/units/ConflictGraphTestRunner.cpp


${TESTDIR}/tests/units/ConflictGraphUnitTest.o: tests/units/ConflictGraphUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ConflictGraphUnitTest.o tests/units/ConflictGraphUnitTest.cpp


${TESTDIR}/tests/units/ConflictListTestRunner.o: tests/units/ConflictListTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ConflictListTestRunner.o tests/units/ConflictListTestRunner.cpp


${TESTDIR}/tests/units/ConflictListUnitTest.o: tests/units/ConflictListUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ConflictListUnitTest.o tests/units/ConflictListUnitTest.cpp


${TESTDIR}/tests/units/DistributionTestRunner.o: tests/units/DistributionTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/DistributionTestRunner.o tests/units/DistributionTestRunner.cpp


${TESTDIR}/tests/units/DistributionUnitTest.o: tests/units/DistributionUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/DistributionUnitTest.o tests/units/DistributionUnitTest.cpp


${TESTDIR}/tests/units/FileHandlerTestRunner.o: tests/units/FileHandlerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/FileHandlerTestRunner.o tests/units/FileHandlerTestRunner.cpp


${TESTDIR}/tests/units/FileHandlerUnitTest.o: tests/units/FileHandlerUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/FileHandlerUnitTest.o tests/units/FileHandlerUnitTest.cpp


${TESTDIR}/tests/units/MathUtilTestRunner.o: tests/units/MathUtilTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/MathUtilTestRunner.o tests/units/MathUtilTestRunner.cpp


${TESTDIR}/tests/units/MathUtilUnitTest.o: tests/units/MathUtilUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/MathUtilUnitTest.o tests/units/MathUtilUnitTest.cpp


${TESTDIR}/tests/units/RandomGeneratorTestRunner.o: tests/units/RandomGeneratorTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/RandomGeneratorTestRunner.o tests/units/RandomGeneratorTestRunner.cpp
...
${OBJECTDIR}/coloring/ConferenceScheduler_nomain.o: ${OBJECTDIR}/coloring/ConferenceScheduler.o coloring/ConferenceScheduler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/ConferenceScheduler_nomain.o coloring/ConferenceScheduler.cpp;\
	else  \
...
${OBJECTDIR}/conflicts/ConflictGraph_nomain.o: ${OBJECTDIR}/conflicts/ConflictGraph.o conflicts/ConflictGraph.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conflicts/ConflictGraph_nomain.o conflicts/ConflictGraph.cpp;\
	else  \
...
${OBJECTDIR}/conflicts/ConflictHandler_nomain.o: ${OBJECTDIR}/conflicts/ConflictHandler.o conflicts/ConflictHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conflicts/ConflictHandler_nomain.o conflicts/ConflictHandler.cpp;\
	else  \
...
${OBJECTDIR}/conflicts/ConflictList_nomain.o: ${OBJECTDIR}/conflicts/ConflictList.o conflicts/ConflictList.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conflicts/ConflictList_nomain.o conflicts/ConflictList.cpp;\
	else  \
...
${OBJECTDIR}/distributions/BinomialDistribution_nomain.o: ${OBJECTDIR}/distributions/BinomialDistribution.o distributions/BinomialDistribution.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/BinomialDistribution_nomain.o distributions/BinomialDistribution.cpp;\
	else  \
...
${OBJECTDIR}/distributions/Distribution_nomain.o: ${OBJECTDIR}/distributions/Distribution.o distributions/Distribution.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/Distribution_nomain.o distributions/Distribution.cpp;\
	else  \
...
${OBJECTDIR}/distributions/SkewedDistribution_nomain.o: ${OBJECTDIR}/distributions/SkewedDistribution.o distributions/SkewedDistribution.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/SkewedDistribution_nomain.o distributions/SkewedDistribution.cpp;\
	else  \
...
${OBJECTDIR}/distributions/TwoTieredDistribution_nomain.o: ${OBJECTDIR}/distributions/TwoTieredDistribution.o distributions/TwoTieredDistribution.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/TwoTieredDistribution_nomain.o distributions/TwoTieredDistribution.cpp;\
	else  \
...
${OBJECTDIR}/distributions/UniformDistribution_nomain.o: ${OBJECTDIR}/distributions/UniformDistribution.o distributions/UniformDistribution.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributions/UniformDistribution_nomain.o distributions/UniformDistribution.cpp;\
	else  \
...
${OBJECTDIR}/utils/FileHandler_nomain.o: ${OBJECTDIR}/utils/FileHandler.o utils/FileHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/FileHandler_nomain.o utils/FileHandler.cpp;\
	else  \
...
${OBJECTDIR}/utils/MathUtils_nomain.o: ${OBJECTDIR}/utils/MathUtils.o utils/MathUtils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/MathUtils_nomain.o utils/MathUtils.cpp;\
	else  \
...
${OBJECTDIR}/utils/RandomNumberGenerator_nomain.o: ${OBJECTDIR}/utils/RandomNumberGenerator.o utils/RandomNumberGenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/RandomNumberGenerator_nomain.o utils/RandomNumberGenerator.cpp;\
	else  \
