...
${OBJECTDIR}/coloring/InOrderOrdering.o: coloring/InOrderOrdering.cpp
	${MKDIR} -p ${OBJECTDIR}/coloring
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/InOrderOrdering.o coloring/InOrderOrdering.cpp

${OBJECTDIR}/coloring/RandomOrdering.o: coloring/RandomOrdering.cpp
	${MKDIR} -p ${OBJECTDIR}/coloring
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/RandomOrdering.o coloring/RandomOrdering.cpp

${OBJECTDIR}/coloring/SmallestLastOrdering.o: coloring/SmallestLastOrdering.cpp
	${MKDIR} -p ${OBJECTDIR}/coloring
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/SmallestLastOrdering.o coloring/SmallestLastOrdering.cpp

${OBJECTDIR}/coloring/Vertex.o: coloring/Vertex.cpp
	${MKDIR} -p ${OBJECTDIR}/coloring
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/Vertex.o coloring/Vertex.cpp
...
${OBJECTDIR}/conference/ConferenceConflictParams.o: conference/ConferenceConflictParams.cpp
	${MKDIR} -p ${OBJECTDIR}/conference
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conference/ConferenceConflictParams.o conference/ConferenceConflictParams.cpp
...
${TESTDIR}/tests/units/ColorOrderingTestRunner.o: tests/units/ColorOrderingTestRunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ColorOrderingTestRunner.o tests/units/ColorOrderingTestRunner.cpp


${TESTDIR}/tests/units/ColorOrderingUnitTest.o: tests/units/ColorOrderingUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ColorOrderingUnitTest.o tests/units/ColorOrderingUnitTest.cpp


${TESTDIR}/tests/units/ColorerTestRunner.o: tests/units/ColorerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ColorerTestRunner.o tests/units/ColorerTestRunner.cpp


${TESTDIR}/tests/units/ColorerUnitTest.o: tests/units/ColorerUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/ColorerUnitTest.o tests/units/ColorerUnitTest.cpp
...
${TESTDIR}/tests/units/VertextTestRunner.o: tests/units/VertextTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/VertextTestRunner.o tests/units/VertextTestRunner.cpp


${TESTDIR}/tests/units/VertextUnitTest.o: tests/units/VertextUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests/units
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/units/VertextUnitTest.o tests/units/VertextUnitTest.cpp
...
${OBJECTDIR}/coloring/InOrderOrdering_nomain.o: ${OBJECTDIR}/coloring/InOrderOrdering.o coloring/InOrderOrdering.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/InOrderOrdering_nomain.o coloring/InOrderOrdering.cpp;\
	else  \
...
${OBJECTDIR}/coloring/RandomOrdering_nomain.o: ${OBJECTDIR}/coloring/RandomOrdering.o coloring/RandomOrdering.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/RandomOrdering_nomain.o coloring/RandomOrdering.cpp;\
	else  \
...
${OBJECTDIR}/coloring/SmallestLastOrdering_nomain.o: ${OBJECTDIR}/coloring/SmallestLastOrdering.o coloring/SmallestLastOrdering.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/SmallestLastOrdering_nomain.o coloring/SmallestLastOrdering.cpp;\
	else  \
...
${OBJECTDIR}/coloring/Vertex_nomain.o: ${OBJECTDIR}/coloring/Vertex.o coloring/Vertex.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coloring/Vertex_nomain.o coloring/Vertex.cpp;\
	else  \
...
${OBJECTDIR}/conference/ConferenceConflictParams_nomain.o: ${OBJECTDIR}/conference/ConferenceConflictParams.o conference/ConferenceConflictParams.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conference/ConferenceConflictParams_nomain.o conference/ConferenceConflictParams.cpp;\
	else  \
